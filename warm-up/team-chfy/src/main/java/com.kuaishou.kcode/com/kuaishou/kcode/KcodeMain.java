...
public class KcodeMain {
    ...
    private static com.kuaishou.kcode.FlyanTimer timer = new com.kuaishou.kcode.FlyanTimer(MODULE_TOTAL);

    public static void main(String[] args) throws Exception {
        /* io-file settings */
        String INPUT_FILENAME = "E:/Projects/kuaishou/kcode-warmup/kcode-warm-up/warmup-test.data";
        String OUTPUT_FILENAME = "E:/Projects/kuaishou/kcode-warmup/kcode-warm-up/result-test.data";
